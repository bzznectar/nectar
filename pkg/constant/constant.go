...
const CPU_NOT_SUITABLE = "Your CPU does not meet the minimum requirements！"
const MEMORY_NOT_SUITABLE = "Your memory does not meet the minimum requirements！"
const DISK_NOT_SUITABLE = "Your disk does not meet the minimum requirements！"
const MinimumDiskSize = 161061273600
const WriteDiskCoefficient = 0.9
